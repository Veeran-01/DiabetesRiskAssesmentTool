<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LowRisk.aspx.cs" Inherits="LowRisk" %>
...
<body background="Content/images/ResultBackground.jpg">
    <form id="form1" runat="server">
			...
			<div class="col-md-8 col-md-offset-2 text-center wrap_title">
                ...
                <div class="lowResult">
				<h2 class="text-success"> Low Risk</h2>
                <br/>
                <p class="lead text-success" style="margin-top:0">Your risk level is <b>'low'</b> which means you need to keep up the good work and maybe make some lifestyle adjustments to further reduce the risk of developing diabetes.
